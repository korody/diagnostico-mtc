...
function isValidBrazilianPhone(phone) {
  ...
  // Aceitar números locais sem DDI: 8 (fixo antigo) ou 9 (celular sem DDD),
  // além dos formatos com DDD (10 ou 11). Isso permite que leads que enviem
  // apenas o número local sejam aceitos; no envio para Unnichat adicionamos
  // um DDD padrão quando necessário.
  return [8, 9, 10, 11].includes(normalized.length);
}
