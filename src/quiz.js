  ...
  return (
    <div className="min-h-screen p-4 pt-8" style={{ background: 'transparent' }}>
      <div className="w-full max-w-lg mx-auto">
        ...
        {/* Botão de Suporte - Canto Superior Direito */}
        <a
          href="https://wa.me/5511998457676?text=Olá!%20Estou%20com%20problema%20no%20quiz%20de%20diagnóstico"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed top-4 right-4 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg transition-all duration-200 hover:scale-110 flex items-center gap-2 text-sm font-medium"
