// enviar-audio-3-leads.js
// Envia áudio personalizado para 3 leads específicos via automação Unnichat
...
const TELEFONES = [
  '5512988981317',  // Mariaclaudianoce
  '5511991358458',  // Helcy Moutinho
  '5549999251500'   // Brigitte
];
  ...
  try {
    ...
    await supabase.from('whatsapp_logs').insert({
      ...
      metadata: {
        ...
        campaign: 'audio_3_leads_especificos'
      },
...
async function main() {
  console.log('\n🎙️ ========================================');
  console.log('   ENVIO DE ÁUDIO VIA AUTOMAÇÃO');
  console.log('   (3 LEADS ESPECÍFICOS)');
  console.log('========================================');
